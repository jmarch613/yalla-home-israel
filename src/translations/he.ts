...
export const heTranslations = {
  ...
  'common.loading': 'טוען...',
  'common.loading.properties': 'טוען נכסים...',
  'common.error': 'שגיאה',
  'common.error.loading': 'נכשל בטעינת נכסים',
  'common.try.again': 'נסה שוב',
  'common.scraping.start': 'מתחיל לאסוף נתונים...',
  'common.scraping.description': 'אוסף נתונים אחרונים של נכסים מ remaxjerusalem.com',
  'common.scraping.success': 'איסוף נתונים הושלם!',
  'common.scraping.success.description': 'נתוני הנכסים עודכנו בהצלחה.',
  'common.scraping.failed': 'איסוף נתונים נכשל',
  'common.scraping.failed.description': 'נכשל באיסוף נתוני נכסים. אנא נסה שוב.',
  'property.showing': 'מציג',
  'property.of': 'מתוך',
  'property.properties': 'נכסים',
  'property.update.data': 'עדכן נתונים',
  'property.sort.most.recent': 'הכי חדש',
