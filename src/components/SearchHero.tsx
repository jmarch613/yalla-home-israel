...
export const SearchHero = () => {
  ...
  return (
    <div className="relative bg-cover text-white py-16" style={{ backgroundImage: 'url(/lovable-uploads/c4e4754d-6d31-4ee6-8d2e-f15103b68059.png)', backgroundPosition: 'left bottom', filter: 'brightness(1.2) contrast(1.1)' }}>
