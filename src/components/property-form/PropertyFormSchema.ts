...
export const propertySchema = z.object({
  ...
  road: z.string().min(1, 'Road name is required'),
  road_number: z.number().min(1, 'Road number is required'),
  flat_number: z.number().optional(),
  entrance_number: z.number().optional(),
